...
export interface ZenCratesGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface ZenCratesGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): ZenCratesGovernor;
  waitForDeployment(): Promise<this>;

  interface: ZenCratesGovernorInterface;
