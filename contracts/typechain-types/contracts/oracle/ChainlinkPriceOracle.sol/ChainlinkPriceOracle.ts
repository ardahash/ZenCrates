...
export interface ChainlinkPriceOracleInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "FEED_ADMIN_ROLE",
    values?: undefined
  ): string;
...
export namespace FeedUpdatedEvent {
  export type InputTuple = [crateId: BytesLike, feed: AddressLike];
  export type OutputTuple = [crateId: string, feed: string];
...
export interface ChainlinkPriceOracle extends BaseContract {
  ...
  FEED_ADMIN_ROLE: TypedContractMethod<[], [string], "view">;

  feeds: TypedContractMethod<[arg0: BytesLike], [string], "view">;
  ...
  setFeed: TypedContractMethod<
    [crateId: BytesLike, feed: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "FEED_ADMIN_ROLE"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  filters: {
    "FeedUpdated(bytes32,address)": TypedContractEvent<
      FeedUpdatedEvent.InputTuple,
      FeedUpdatedEvent.OutputTuple,
      FeedUpdatedEvent.OutputObject
    >;
