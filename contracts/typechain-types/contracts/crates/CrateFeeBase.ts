...
export interface CrateFeeBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "FEE_MANAGER_ROLE"
...
export interface CrateFeeBase extends BaseContract {
  connect(runner?: ContractRunner | null): CrateFeeBase;
  waitForDeployment(): Promise<this>;

  interface: CrateFeeBaseInterface;
