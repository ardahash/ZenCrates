...
export interface StrategyCrateInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "FEE_MANAGER_ROLE"
...
export interface StrategyCrate extends BaseContract {
  connect(runner?: ContractRunner | null): StrategyCrate;
  waitForDeployment(): Promise<this>;

  interface: StrategyCrateInterface;
