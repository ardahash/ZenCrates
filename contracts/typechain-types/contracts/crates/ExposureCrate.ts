...
export interface ExposureCrateInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "FEE_MANAGER_ROLE"
...
export namespace OracleUpdatedEvent {
  export type InputTuple = [oracle: AddressLike, oracleId: BytesLike];
  export type OutputTuple = [oracle: string, oracleId: string];
  export interface OutputObject {
    oracle: string;
    oracleId: string;
  }
...
export interface ExposureCrate extends BaseContract {
  connect(runner?: ContractRunner | null): ExposureCrate;
  waitForDeployment(): Promise<this>;

  interface: ExposureCrateInterface;
  ...
  oracleId: TypedContractMethod<[], [string], "view">;
  ...
  setOracle: TypedContractMethod<
    [newOracle: AddressLike, newOracleId: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  filters: {
    ...
    "OracleUpdated(address,bytes32)": TypedContractEvent<
      OracleUpdatedEvent.InputTuple,
      OracleUpdatedEvent.OutputTuple,
      OracleUpdatedEvent.OutputObject
    >;
