...
export interface CratesTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "DOMAIN_SEPARATOR"
...
export interface CratesToken extends BaseContract {
  connect(runner?: ContractRunner | null): CratesToken;
  waitForDeployment(): Promise<this>;

  interface: CratesTokenInterface;
