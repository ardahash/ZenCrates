        ...
        <div className="mx-auto max-w-7xl px-4 py-24 lg:px-8 lg:py-32">
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="max-w-3xl text-balance text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
              Crates for market exposure and macro strategies
            </h1>
            <p className="mt-6 max-w-2xl text-pretty text-lg leading-relaxed text-muted-foreground">
              Non-custodial synthetic index tokens and rules-based strategy
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              investment advice. Synthetic tokens do not represent ownership
